...
public class User {
	...
	public User(String username, String password, String creationDate, Integer numberOfAccounts, String listOfAccounts,
			Integer totalBalance, String contactNumber, String roles, boolean active) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		User other = (User) obj;
		return active == other.active && Objects.equals(contactNumber, other.contactNumber)
